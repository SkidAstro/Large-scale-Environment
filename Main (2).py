...
## add galaxies info from text file
def add_galaxy(filename):
        try:
                ...
                for line in lines:
                        ...
                        # Assign node name as group ID makes searching in tree faster!
                ...
                print ("\tADD_GALAXY: (file): wrong format!"+
                       ...
                       "1. NOT RECCOMMEND table header, NOT RECCOMMEND EMPTY LINE AT THE END -> just the data\n"+
                       "2. SHOULD ONLY contain number\n"+
                       "3. NOTE the columns include: ID, RA, Dec, zRS (NOTE: It's z, not C*z)\n"+
                       "4. FOLLOW the following format: (4 columns, seperated by tab)\n"+
                       "\t123\t123\t123\t123\n\t...\t...\t...\t...\n\t...\t...\t...\t...\n\t...\t...\t...\t...")              
                sys.exit()
...
## FINALE EXPORT TO LIST WITH ENVIRONMENT ATTRIBUTE
def output_final_list(galaxy_full, inputList):
        ...
        for G in inputList:
                ...
                # if input node name in stead of string into that G.node[] box error is returned!
        return H

## FINALE EXPORT TO LIST WITH ENVIRONMENT ATTRIBUTE SORTED
...
## as re-importing the graph helps to speed up edge adition in finding MST of tendril'''
...
## This is very important because here we input with textfile so all the attributes are in float or int
...
## be probel mwith void and tendril galaxies. So we need the line below to read the void and tendril from GEXF
